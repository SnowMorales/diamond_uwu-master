...
AddEventHandler('esx_society:withdrawMoney', function(societyName, amount)
	...
	TriggerEvent('esx_addonaccount:getSharedAccount', society.account, function(account)
		if amount > 0 and account.money >= amount then
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You have withdrawn money from the company', 5000 })
		end
	end)
end)
...
AddEventHandler('esx_society:depositMoney', function(societyName, amount)
	...
	if amount > 0 and xPlayer.getMoney() >= amount then
		TriggerEvent('esx_addonaccount:getSharedAccount', society.account, function(account)
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You have depostied money to the company', 5000 })
...
lib.callback.register('esx_society:setJob', function(source, identifier, job, grade, actionType)
	...
	if actionType == 'hire' then
		...
		--Config.Notify('you_have_hired', xPlayer.source, xTarget.getName())
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = 'you_have_been_hired', xTarget.source, job, 5000 })
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = 'you_have_hired', xPlayer.source, xTarget.getName(), 5000 })
	elseif actionType == 'promote' then
		...
		--Config.Notify('you_have_promoted', xPlayer.source, xTarget.getName(), xTarget.getJob().grade_label)
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = 'you_have_been_promoted', xTarget.source, 5000 })
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = 'you_have_promoted', xPlayer.source, xTarget.getName(), xTarget.getJob().grade_label, 5000})
	elseif actionType == 'demote' then
		...
		--Config.Notify('you_have_demoted', xPlayer.source, xTarget.getName(), xTarget.getJob().grade_label)
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = 'you_have_been_demoted', xTarget.source, 5000 })
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = 'you_have_demoted', xPlayer.source, xTarget.getName(), xTarget.getJob().grade_label, 5000})
	elseif actionType == 'fire' then
		...
		--Config.Notify('you_have_fired', xPlayer.source, xTarget.getName())
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = 'you_have_been_fired', xTarget.source, xPlayer.getJob().label, 5000 })
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'you_have_fired', xPlayer.source, xTarget.getName(), 5000})
	end
	return true
end)
...
lib.callback.register('esx_society:setJobSalary', function(source, job, grade, salary, gradeLabel)
	...
	if xPlayer.job.name == job and Config.BossGrades[xPlayer.job.grade_name] then
		if salary <= Config.MaxSalary then
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'salary_change', xPlayer.source, salary, gradeLabel, 5000})
				return true
			end)
		else
...
lib.callback.register('esx_society:setJobLabel', function(source, job, grade, label)
    ...
    if xPlayer.job.name == job and Config.BossGrades[xPlayer.job.grade_name] then
        ...
        function(rowsChanged)
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'grade_change', xPlayer.source, label, 5000})
			return true
        end)
    else
